...
# for me:
#   export TF_INC=/opt/anaconda3/lib/python3.6/site-packages/tensorflow/include
...
## either one of these should work. just trial and error
...
# for gcc5-built tf
#g++ -std=c++11 -shared -D_GLIBCXX_USE_CXX11_ABI=1 -o roi_pooling.so roi_pooling_op.cc roi_pooling_op.cu.o -I $TF_INC -fPIC -lcudart -L $CUDA_PATH/lib64


cd ..
###############################################################################################3
#psroi_pooling layer is not required for didinet
